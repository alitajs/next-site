...
Next.js introduced
[Static Site Generation methods in 9.3](https://nextjs-cn.com/blog/next-9-3#next-gen-static-site-generation-ssg-support)
...
using the [`fallback: true` option in `getStaticPaths`](https://nextjs-cn.com/docs/basic-features/data-fetching#the-fallback-key-required),
...
[preview mode](https://nextjs-cn.com/docs/advanced-features/preview-mode), are now
...
[the `getStaticProps` documentation](https://nextjs-cn.com/docs/basic-features/data-fetching#getstaticprops-static-generation).
...
For more details, check out
[the `basePath` documentation](https://nextjs-cn.com/docs/api-reference/next.config.js/basepath).
...
[rewrites documentation](https://nextjs-cn.com/docs/api-reference/next.config.js/rewrites).
...
[redirects documentation](https://nextjs-cn.com/docs/api-reference/next.config.js/redirects).
...
[headers documentation](https://nextjs-cn.com/docs/api-reference/next.config.js/headers).
...
[trailingSlash documentation](https://nextjs-cn.com/docs/api-reference/next.config.js/trailing-slash)
...
[improved code-splitting strategy in Next.js 9.2](https://nextjs-cn.com/blog/next-9-2#improved-code-splitting-strategy)
...
We
[introduced Fast Refresh in Next.js 9.4](https://nextjs-cn.com/blog/next-9-4#fast-refresh),
...
- **New documentation**: We've
  [added extensive documentation](https://nextjs-cn.com/docs/basic-features/fast-refresh)
...
- **User-code troubleshooting guide**: The new documentation also includes
  [common troubleshooting steps and tips](https://nextjs-cn.com/docs/basic-features/fast-refresh#tips)
...
Next.js 9.2 added
[support for catch-all dynamic routes](https://nextjs-cn.com/blog/next-9-2#catch-all-dynamic-routes)
...
[router query object](https://nextjs-cn.com/docs/api-reference/next/router#router-object)
...
You can
[learn more about optional catch all routes in our documentation](https://nextjs-cn.com/docs/routing/dynamic-routes#optional-catch-all-routes).
...
[nextjs-cn.com](http://nextjs-cn.com) and [vercel.com](http://vercel.com) in
...
- [On-demand-entries](https://nextjs-cn.com/blog/next-8#improved-on-demand-entries),
  ...
  for our use case.
- [React Fast Refresh and the Next.js Error Overlay](https://nextjs-cn.com/blog/next-9-4#fast-refresh)
...
**重要信息:** if your project has
[custom webpack configuration](https://nextjs-cn.com/docs/api-reference/next.config.js/custom-webpack-config),
