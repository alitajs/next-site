...
Since our last major release, we are happy to have seen companies like [TikTok](https://www.tiktok.com/en/), [Hilton](https://www.hilton.com/en/hilton/), [Elastic](https://www.elastic.co), [Realtor](https://www.realtor.com/), and [JW Player](https://www.jwplayer.com/) launch with Next.js. Check out the [showcase](https://nextjs-cn.com/showcase) for more!
...
We are planning to add the [automatic static optimization](https://nextjs-cn.com/blog/next-9#automatic-static-optimization) for expected errors as in general, they do not have to be dynamically rendered.
...
As shared in the [Next.js 9 announcement](https://nextjs-cn.com/blog/next-9#google-chrome-collaboration) the Google Chrome team is investing resources into improving Next.js and has been working on multiple efforts to make large-scale performance improvements for all Next.js applications.

To learn more about this collaboration you can read the [Next.js 9 announcement](https://nextjs-cn.com/blog/next-9#google-chrome-collaboration) and watch [this talk by Nicole Sullivan at React Rally](https://www.youtube.com/watch?v=XD8UQeYm5Vk).
