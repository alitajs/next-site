...
If you don't have a need for the Next.js runtime, using AMP-first pages could help speed up development. AMP-First requires you to only use AMP compatible components to build your pages. AMP-First pages are currently in production on [nextjs-cn.com/docs](http://nextjs-cn.com/docs) and [nextjs-cn.com/blog](http://nextjs-cn.com/blog).
