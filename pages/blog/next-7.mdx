...
export const meta = {
  ...
  url: 'https://nextjs-cn.com/blog/next-7',
  link: '/blog/next-7',
  authors: [
    {
      name: 'Tim Neutkens',
...
Finally, we are excited to be sharing this news on the all-new nextjs-cn.com
...
Together with the Next.js 7 release, we are launching a completely redesigned [nextjs-cn.com](https://nextjs-cn.com).

### Blog

The blog post you are currently reading is already part of the new blog section on [nextjs-cn.com](https://nextjs-cn.com). This blog will be the new home for communication related to Next.js, for example, new version announcements.

<Image
  src="/static/blog/next-7/homepage.png"
  width={2466 / 2.5}
  height={1698 / 2.5}
  caption="The new nextjs-cn.com"
/>
...
<Image
  ...
  width={2466 / 2.5}
  height={1698 / 2.5}
  caption="Get inspired on nextjs-cn.com/showcase"
/>
