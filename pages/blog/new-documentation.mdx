...
In addition to the new and improved documentation, we've made some changes to [nextjs-cn.com/learn](http://nextjs-cn.com/learn), making it even easier to get started using Next.js:
...
- [nextjs-cn.com/docs/basic-features/pages](https://nextjs-cn.com/docs/basic-features/pages): what `pages` are in Next.js and how they relate to static generation and server-side rendering.
- [nextjs-cn.com/docs/routing/introduction](https://nextjs-cn.com/docs/routing/introduction): The different types of routes that are supported on the filesystem.
...
## nextjs-cn.com/learn Improvements

The [nextjs-cn.com/learn](http://nextjs-cn.com/learn) website is an interactive learning experience that guides you through many of the features Next.js offers by default.
...
Recently we've lifted this limitation and all lessons are now available without login. Allowing you to start learning Next.js immediately on nextjs-cn.com/learn.
...
<Image
  caption={'API Routes lesson in nextjs-cn.com/learn.'}
  captionSpacing={30}
...
If you have any feedback about the new documentation you can use the feedback input at the bottom of each page on [nextjs-cn.com/docs](https://nextjs-cn.com/docs)
