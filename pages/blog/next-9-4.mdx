...
You can read more about the `.env` loading in the [Environment Variables documentation](https://nextjs-cn.com/docs/basic-features/environment-variables).
...
In [Next.js 9.1.7](https://nextjs-cn.com/blog/next-9-1-7#new-built-in-polyfills-fetch-url-and-objectassign) we announced polyfilling of the [`fetch()`](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API) API in the browser. Today this polyfilling has been extended to the Node.js environment too.
...
To use this method in combination with your analytics service refer to the ["Sending result to Analytics"](https://nextjs-cn.com/docs/advanced-features/measuring-performance#sending-results-to-analytics) section of the docs. If you want to learn more about Core Web Vitals you can refer to [web.dev/vitals](https://web.dev/vitals/).
...
When built-in Sass support was launched in [Next.js 9.3](https://nextjs-cn.com/blog/next-9-3#built-in-sass-support-for-global-stylesheets) we got the feedback that a subset of users wanted to configure the sass compiler. For example to configure `includePaths`.
