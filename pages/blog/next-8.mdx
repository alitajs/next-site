...
With [Next.js 7 we optimized the initial payload to 1.50KB](https://nextjs-cn.com/blog/next-7/#smaller-initial-html-payload), which was a 7.4% reduction from the previous version.
