...
export const meta = {
  title: 'Next.js 6 and nextjs-cn.com',
  description:
  ...
  url: 'https://nextjs-cn.com/blog/next-6',
  link: '/blog/next-6',
  twitterCard:
...
In addition to the 6.0 release, we're moving to feature Next.js on its very own homepage, [nextjs-cn.com](https://nextjs-cn.com), featuring:

- All the Next.js documentation in one place. No more lookups of the README file on GitHub
- Merging [https://learnnextjs.com](https://learnnextjs.com) into [https://nextjs-cn.com/learn](https://nextjs-cn.com/learn)
...
Until now, static exporting in Next.js was very powerful but not sufficiently easy to use. It required setting up [a manual route map](https://nextjs-cn.com/docs#static-html-export) even when no custom routes were in use.
...
We are very happy to introduce the new [nextjs-cn.com](https://nextjs-cn.com), built by Next.js core contributor [Jimmy Moon](https://twitter.com/ragingwind).
...
<Video
  ...
  height={524/1.5}
/>
<Caption>The opening video of <GenericLink href="https://nextjs-cn.com/">`nextjs-cn.com`</GenericLink></Caption>

### One place for our documentation

When you need to look up something quickly, just head to [nextjs-cn.com/docs](https://nextjs-cn.com/docs):
...
Now we've integrated it directly into [nextjs-cn.com/learn](https://nextjs-cn.com/learn) to make it even easier start learning:
...
We are now featuring a showcase of some nice-looking websites and applications built on Next.js. Head to [nextjs-cn.com/showcase](https://nextjs-cn.com/showcase) to get inspired, or [submit your own](https://github.com/vercel/next.js/issues/new?template=4.nextjs-cn.com_showcase.md)!
