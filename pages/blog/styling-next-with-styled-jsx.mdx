...
In Next.js, we can load the layout once for all pages by creating a custom [`App` component](https://nextjs-cn.com/docs#custom-app) within `pages/_app.js`, importing the `Layout` component, and then adding it to the render method as follows:
