...
Check out the [showcase](https://nextjs-cn.com/showcase) for more!

## Built-In Zero-Config TypeScript Support

One year ago [Next.js 6](https://nextjs-cn.com/blog/next-6) introduced basic TypeScript
...
You can [read more about this feature in the Next.js Documentation](https://github.com/vercel/next.js#dynamic-routing) or [Next.js Learn section](https://nextjs-cn.com/learn/basics/clean-urls-with-dynamic-routing).
...
> **注意**: API Routes also support [Dynamic Routes](#dynamic-route-segments)!
...
Initially this configuration allows you to opt-into [AMP](https://nextjs-cn.com/blog/next-8-1),
