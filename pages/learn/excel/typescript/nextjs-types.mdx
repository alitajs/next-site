...
关于 [`getStaticProps`](/docs/basic-features/data-fetching#getstaticprops-static-generation)、 [`getStaticPaths`](/docs/basic-features/data-fetching#getstaticpaths-static-generation) 和 [`getServerSideProps`](/docs/basic-features/data-fetching#getserversideprops-server-side-rendering)，你可以分别使用 `GetStaticProps`、`GetStaticPaths` 和 `GetServerSideProps` 类型:
...
以下是如何将内置类型用于 [API routes](/docs/api-routes/introduction) 的示例：
...
> 了解更多在 Next.js 中使用 TypeScript，查看[我们的 TypeScript 文档](/docs/basic-features/typescript)。
