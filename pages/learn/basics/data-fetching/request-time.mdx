...
因为 [`getServerSideProps`](/docs/basic-features/data-fetching#getserversideprops-server-side-rendering) 是在请求时调用的，所以它的参数(`context`)包含请求特定的参数。你可以在<Link href="/docs/[[...slug]]" as="/docs/basic-features/data-fetching#getserversideprops-server-side-rendering"><a>我们的文档</a></Link>中了解更多信息。
