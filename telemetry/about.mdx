...
For example, <OrgText /> [dogfoods](https://en.wikipedia.org/wiki/Eating_your_own_dog_food) many large React applications (e.g. <PlatformLink href='/' />, <PlatformLink href='/docs' />, [https://nextjs-cn.com](https://nextjs-cn.com)). Additionally, we actively engage with the community to gather feedback.<br/>
...
> **注意**: This list is regularly audited to ensure its accuracy.
