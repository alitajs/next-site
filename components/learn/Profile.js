...
const tweet = points => {
  const url = `https://twitter.com/intent/tweet?url=https%3A%2F%2Fnextjs-cn.com%2Flearn&text=我刚刚在 Next.js 中文官网上获得了${points}%20points✨%20on&via=${TWITTER_USER_NAME}`;
